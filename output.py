...
def write_out(suffix, position, speed, pot_energy, kin_energy, energy, mean_pot_energy, mean_kin_energy):
    ...
    f = open('positions'+suffix.strip()+'.dat','w')
    ...
    f = open('velocities'+suffix.strip()+'.dat','w')
