...
class System:
    ...
    def __init__(self, num_rep, a = 0.04, C = 0.3):
        ...
        self.K =(self.num_rep * cst.m_p * cst.Boltzmann**2 * self.temp**2) / cst.hbar**2
    ...
    def kinetic_energy(self):
        return np.sum(0.5 * cst.m_p * self.speeds**2 - 0.5 * self.K * (self.positions - np.roll(self.positions, 1))**2)
